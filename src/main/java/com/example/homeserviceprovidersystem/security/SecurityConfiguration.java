    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/customer/onlinePayment/{customerEmail}/{orderId}").hasAuthority("CUSTOMER")
                        ...
                        .requestMatchers("/customer/onlinePaymentPortal/{customerEmail}/{orderId}").hasAuthority("CUSTOMER")
                        .requestMatchers("/customer/generateCaptcha").hasAuthority("CUSTOMER")
                        .requestMatchers("/customer/timeout").hasAuthority("CUSTOMER")
                        .requestMatchers("/customer/successfullyPayment").hasAuthority("CUSTOMER")
                        .requestMatchers("/customer/verifyToken").hasAuthority("CUSTOMER")
                        ...
                        .requestMatchers("/expert/verifyToken").hasAuthority("EXPERT")
